          ...
          <div className="grid grid-cols-[280px_1fr] gap-4 mb-4 max-md:grid-cols-1">
            ...
            >
              ...
              <button onClick={runCompression} disabled={compressing || files.length === 0}
                className="w-full bg-[var(--accent)] text-black border-none py-2.5 rounded-lg font-extrabold text-sm cursor-pointer transition-all hover:brightness-110 active:brightness-125 disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100 shadow-[0_4px_16px_var(--accent-glow)]"
              >
            ...
            >
              ...
              <div onClick={() => inputRef.current?.click()}
                className="border-2 border-dashed border-[rgba(255,255,255,0.06)] rounded-lg flex flex-col items-center justify-center cursor-pointer p-5 gap-1.5 min-h-[180px] transition-all hover:border-[var(--accent)] hover:bg-[var(--accent)]/5"
              >
