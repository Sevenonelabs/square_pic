...
export function Navbar() {
  ...
  return (
    <header className="fixed top-3 left-1/2 -translate-x-1/2 w-auto min-w-[380px] max-w-[calc(100vw-24px)] h-11 bg-[rgba(5,5,7,0.82)] backdrop-blur-[28px] saturate-[1.6] border border-[rgba(255,255,255,0.06)] rounded-lg px-1.5 z-50 flex items-center justify-between shadow-[0_4px_24px_rgba(0,0,0,0.4)] max-lg:min-w-0 max-lg:w-[calc(100%-16px)] max-lg:px-1 max-lg:h-10 max-md:top-1.5 max-md:h-9">
      <div className="flex items-center h-11 gap-2 max-lg:h-10 max-md:h-9 flex-1">
        <button
          onClick={toggleSidebar}
          className="w-8 h-8 flex items-center justify-center bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-sm text-[#8d9aaa] cursor-pointer transition-all duration-300 shrink-0 hover:bg-[rgba(255,255,255,0.08)] hover:border-[rgba(255,255,255,0.10)] hover:text-[#e6edf5] max-md:w-7 max-md:h-7"
