...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${SITE}/blog/categories/${slug}` },
  };
}
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: "Categories", url: `${SITE}/blog/categories` },
        { name: cat.name, url: `${SITE}/blog/categories/${slug}` },
      ]} />
      <div className="max-w-[680px] w-full mx-auto px-4 py-8">
        <Link href="/blog/categories" className="text-[0.7rem] font-semibold text-[#576675] no-underline hover:text-[var(--accent)] transition-colors inline-flex items-center gap-1 mb-4">
