...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Privacy-First Image Editing: Why Your Photos Should Stay on Your Device | SquarePic", type: "article", publishedTime: "2026-07-13", authors: "SevenOneLabs" },
