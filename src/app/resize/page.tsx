...
export const metadata: Metadata = {
  title: "Social Media Image Sizes - Complete Dimension Guide 2026",
  description: "Complete guide to every social media image size. Find exact pixel dimensions for Instagram, Facebook, X (Twitter), LinkedIn, TikTok, YouTube, Pinterest, and more.",
  openGraph: { title: "Social Media Image Sizes - Complete Dimension Guide 2026 | SquarePic" },
};
...
export default function ResizeHubPage() {
  ...
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: SITE }, { name: "Social Media Image Sizes", url: `${SITE}/resize` }]} />
      ...
      <div className="text-center mb-8 p-8 bg-gradient-to-br from-[rgba(6,182,212,0.04)] to-[rgba(139,92,246,0.04)] border border-[rgba(6,182,212,0.08)] rounded-lg">
        <h1 className="text-[1.5rem] font-extrabold tracking-tight mb-2">Social Media Image Sizes: The Complete Guide</h1>
        <p className="text-[0.85rem] text-[#8d9aaa] max-w-[600px] mx-auto leading-relaxed">
          Find the exact pixel dimensions for every social media platform. Click any platform to see all its image sizes with detailed descriptions and pro tips. Each guide includes the correct aspect ratio, recommended safe zones for text placement, and best practices for creating images that look great on every device. Whether you need a profile picture, cover photo, post image, or story, you will find the exact specifications here.
        </p>
      </div>
